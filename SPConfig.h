...
typedef enum sp_config_msg_t {
	...
	SP_CONFIG_VARIABLE_ALREADY_SET,
	SP_CONFIG_NO_SUCH_VAR,
...
/* Returns the number of similar images to find set in the configuration file, i.e the value
...
/* Returns the number of images to find set in KNN in the configuration file, i.e the value
 * of spKNN.
 *
 * @param config - the configuration structure
 * @assert msg != NULL
...
/* Returns the logger level in the configuration file, i.e the value
 * of spLoggerLevel.
 *
 * @param config - the configuration structure
 * @assert msg != NULL
...
/**
 * The function stores in loggerPath the full path of the logger file.
 * @param imagePath - an address to store the result in, it must contain enough space.
 * @param config - the configuration structure
 * @return
 *  - SP_CONFIG_INVALID_ARGUMENT - if imagePath == NULL or config == NULL
